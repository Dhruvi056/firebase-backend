...
(function () {
  ...
  function addActiveClass(element) {
    ...
    if (current === "") {
      // For root url
      if (element.getAttribute('href').indexOf("index-2.html") !== -1) {    // Checking href of 'element' matching with 'index.html'
  ...
  // Buy Now & Doc buttons removed for production
  /*
  ...
  */
  ...
  // Enable lucide icons with SVG markup - disabled here to avoid React removeChild errors
  // lucide.createIcons();
